                ...
                if (flight.equalsIgnoreCase("roundtrip")) {
                    while (true) {
                        ...
                        * Memphis MEM <- 2h 57m -> New York JFK $116""");
                        ...
                        String to = sc.next();
                        if (BookingInfo.rightFlightRoundtrip(where, to)) {
...
//                            BookingInfo.viewTickets();
                    ...
                    while (true) {
                        ...
                        System.out.println("""
                                ...
                                * Oneway Trip --> Atlanta ATL $50
                                * Oneway Trip --> Los Angeles LAX $101
                                * Oneway Trip --> Chicago O'Hare ORD $89
                                * Oneway Trip --> Mexico City MEX $225""");
                        System.out.println("Where are you traveling to?(Enter Airport)");
                        String to = sc.next();
